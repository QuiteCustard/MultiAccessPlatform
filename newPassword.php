                            ...
                            <div class="col-lg-6 primary">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 textOuter mb-2">Reset your password here!</h1>
                                        <p class="mb-4">We get it, stuff happens and you forgot your password, lucky you can reset it here, right?</p>
                                    </div>
                                    <form method="POST" action="#">
                                        <div class="form-group">
                                            <input name="newPassword" type="password" class="form-control form-control-user primary" required placeholder="new password">
                                        </div>
